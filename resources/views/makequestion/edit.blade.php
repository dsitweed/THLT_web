...
<body style="background-color: #63e9ab">
  <div class="container">
            ...
            <tbody>
              ...
              <div class="form-group">
                <tr class="bg-success">
                  ...
                  <td>
                    <input name="choice1" class="form-control" value="{{$question->choice1}}" type="text" readonly>
                  </td>
                </tr>
              </div>
              <div class="form-group">
                <tr class="danger">
                  ...
                  <td>
                    <input name="choice2" class="form-control" value="{{$question->choice2}}" type="text" readonly>
                  </td>
                </tr>
              </div>
              <div class="form-group">
                <tr class="bg-success">
                  ...
                  <td>
                    <input name="choice3" class="form-control" value="{{$question->choice3}}" type="text" readonly>
                  </td>
                </tr>
              </div>
              <div class="form-group">
                <tr class="warning">
                  ...
                  <td>
                    <input name="choice4" class="form-control" value="{{$question->choice4}}" type="text" readonly>
                  </td>
                </tr>
              </div>
              <div class="form-group">
                <tr class="bg-success">
                  ...
                  <td>
                    <input name="answer" class="form-control" value="{{$question->answer}}" type="text" readonly>
                  </td>
                </tr>
              </div>
            </tbody>
    ...
    @endforeach 
    <a href="/">
      <button type="button" name="ReviewDone" class="btn btn-primary btn-block">Review Done</button>
    </a>
    <br>
    <br>
</body>
