        ...
        <div class="">
            ...
            <form action="/examinfo" method="POST">
                ...
                <div class="flex flex-col mx-auto w-2/3">
                    ...
                    <input class="{{$inputClass}}" type="text" id="name" name="name" :value="old('name')" required autofocus 
                    ...
                    <input class="{{$inputClass}}" type="number" min="1" id="question_lenth" name="question_lenth" :value="old('question_lenth')" required 
                        class="block mt-1 w-full"
                    />
                    ...
                    <input class="{{$inputClass}}" type="number" min="1" id="time" name="time" :value="old('time')" required 
                        class="block mt-1 w-full"
                    />
                    @error('time')
                        <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                    ...
                    <button class="mt-4 text-xl rounded-lg mx-auto w-2/6 bg-slate-300 text-green-600 p-3 font-bold">Submit</button>
                </div>
            </form>
        </div>
    @endif
