		...
		@csrf
			...
			<div class="">
				<div class="flex flex-col">
					<label class="" for="formGroupExampleInput">Câu hỏi số: {{$questionCount}}</label>
				...
				<div class="grid grid-rows-2 grid-flow-col gap-4">
					...
					<div class="form-group">
						...
						<input type="text" name="option4" class="{{$inputClass}}" id="formGroupExampleInput2" required>
					</div>
				</div>
				<div class="form-group">
			...
			<button type="Submit" class="p-2 mt-4 rounded-md font-medium w-full text-lg bg-slate-500">Submit</button>
	</form>
</div>
